...
se.features <- SelectIntegrationFeatures(object.list = se.lst, nfeatures = 2000)
...
se.integrated <- RunUMAP(object = se.integrated, dims = 1:20)
se.integrated <- FindNeighbors(se.integrated, dims = 1:20)
